...
class SdbusNm:
    ...
    def get_networks(self):
        ...
        if self.wlan_device:
            ...
            networks.extend(
                {
                    "SSID": ap.ssid.decode("utf-8", errors='ignore'), # FLSUN Change
                    "known": self.is_known(ap.ssid.decode("utf-8", errors='ignore')), # FLSUN Change
    ...
    def add_network(self, ssid, psk, eap_method, identity="", phase2=None):
        ...
        properties: NetworkManagerConnectionProperties = {
            ...
            "802-11-wireless": {
                ...
                "ssid": ("ay", ssid.encode("utf-8", errors='ignore')), # FLSUN Change
