    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options = [
            ...
            {"theme": {
                "section": "main", "name": _("Icon Theme"), "type": "dropdown",
                "tooltip": _("Changes how the interface looks"),
                "value": "flsun-blue", "callback": screen.change_theme, "options": [
                    {"name": "flsun-blue" + " " + _("(default)"), "value": "flsun-blue"}]}},
            # End FLSUN Changes
        ...
        themes = [
            ...
            if (not os.path.isfile(os.path.join(t_path, d))
                #and d not in ("z-bolt", "printers")) # FLSUN Changes
                and d not in ("flsun-blue", "printers")) # FLSUN Changes
        ]
        themes.sort()
