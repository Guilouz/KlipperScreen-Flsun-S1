...
class Panel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        self.buttons = {
            'extrude': self._gtk.Button("extrude", _("Purge More"), "color4"),
        ...
        self.labels['extrude_dist'] = Gtk.Label(_("Purge Distance (mm)"))
        ...
        self.labels['extrude_speed'] = Gtk.Label(_("Purge Speed (mm/s)"))
        ...
        sensors.set_margin_top(20)
        sensors.set_margin_bottom(20)
        with_switches = (
        ...
        if self._screen.vertical_mode:
            ...
            hbox.pack_start(self.buttons['unload'], True, True, 0)
            hbox.pack_start(self.buttons['load'], True, True, 0)
            hbox.pack_start(self.buttons['extrude'], True, True, 0)
            grid.attach(hbox, 0, 2, 4, 1)
    ...
    def check_min_temp(self, widget, method, direction):
        ...
        min_extrude_temp = float(self._printer.config[self.current_extruder].get('min_extrude_temp', 200))
